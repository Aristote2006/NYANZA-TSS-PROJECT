...
const AddLeader = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.msg || 'Failed to add leader');
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        <Box sx={{ textAlign: 'center', mb: 4 }}>
          ...
          <Typography variant="h6" color="text.secondary">
            Add a new school leader or staff member
          </Typography>
        </Box>
        ...
        {success && (
          <Alert severity="success" sx={{ mb: 3, borderRadius: 2 }}>
            Leader added successfully! Redirecting...
          </Alert>
        )}
                ...
                <Grid item xs={12}>
                  <Box sx={{ 
                    ...
                    <label htmlFor="image-upload">
                      ...
                      >
                        {previewImage ? 'Change Image' : 'Upload Leader Image'}
                      </Button>
                    </label>
                    {previewImage && (
